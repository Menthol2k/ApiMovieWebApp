                                ...
                                <ComboboxOptions v-if="query === '' || filteredPeople.length > 0"
                                    ...
                                    <div
                                        ...
                                        <div hold class="-mx-2 text-sm text-gray-700">
                                            <ComboboxOption v-for="person in query === '' ? recent : filteredPeople"
                                                ...
                                                <div
                                                    :class="['group flex cursor-default items-center rounded-md p-2 select-none', active && 'bg-gray-100 text-gray-900 outline-hidden']">
                                    ...
                                    <div v-if="activeOption"
                                        ...
                                        <div class="flex flex-auto flex-col justify-between p-6">
                                            ...
                                            <button type="button"
                                                class="mt-6 w-full rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Send
                                                message</button>
                                        </div>
                                    </div>
                                </ComboboxOptions>
